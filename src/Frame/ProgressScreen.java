...
public class ProgressScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Go Futsal adalah aplikasi booking lapangan futsal yang dibuat untuk memudahkan dalam memanajemen");

        jLabel7.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("sistem sewa lapangan futsal. Aplikasi ini dibuat dengan bahasa pemograman java.");

        jLabel8.setFont(new java.awt.Font("Dialog", 1, 10)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 204, 0));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("@2021 KELOMPOK 5 ");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/futsalPlanet3.png"))); // NOI18N
        ...
        jLabel3.setText("GOFUTSAL APPLICATION");

        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Planet Futsal Kediri");
    ...
    public static void main(String args[]) {
        ...
        try {
            for(int i=0;i<100;i++){
                Thread.sleep(80);
                ps.loading.setText(Integer.toString(i)+"%");
                ps.loadingBar.setValue(i);
            }
